        ...
        const message =
          typeof payload === 'object' && payload && 'error' in payload
            ...
            : typeof payload === 'string'
              ? payload
              : `${t('apiErrorPrefix')}: ${response.status}`
  ...
  return (
    ...
    >
      ...
      <Routes>
        ...
        <Route
          path="/introductions"
          element={<PlaceholderPage title={t('menuIntroductions')} description={t('placeholderDescription')} />}
        />
        <Route path="/projects" element={<PlaceholderPage title={t('menuProjects')} description={t('placeholderDescription')} />} />
        <Route path="/strategy" element={<PlaceholderPage title={t('menuStrategy')} description={t('placeholderDescription')} />} />
